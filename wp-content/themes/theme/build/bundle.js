...
/***/ "./src/js/template_parts/section_clients.es6":
/*!***************************************************!*\
  !*** ./src/js/template_parts/section_clients.es6 ***!
  \***************************************************/
...
(function ($) {
  var quote = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".clients__slider", quoteOptions);
})(jQuery);
if (document.querySelector(".play-video")) {
  var btns = document.querySelectorAll(".play-video");
  var wrapper = document.querySelector(".global_video_player");
  var closeBtn = document.querySelector(".global_video_player .close");
  var overlay = document.querySelector(".global_video_player .overlay");
  ...
  var closeItems = [closeBtn, overlay];
...
/***/ "./src/js/template_parts/section_form.es6":
/*!************************************************!*\
  !*** ./src/js/template_parts/section_form.es6 ***!
  \************************************************/
/***/ (function() {
...
jQuery(function ($) {
  ...
  buttonSubmit.addEventListener("click", function (e) {
    ...
    var _success = document.querySelector(".form__success");
    var fail = document.querySelector(".form__fail");
    var inputName = document.querySelector(".form__name");
    var inputEmail = document.querySelector(".form__email");
    var inputTextarea = document.querySelector(".form__textarea");
    var fields = [inputName, inputEmail, inputTextarea];
  ...
  var removePosts = function removePosts() {
    var deletePosts = document.querySelectorAll('.delete_post');
    deletePosts.forEach(function (deletePost) {
...
(function ($) {
  $(".clients__slider").length > 0 && __webpack_require__(/*! ./template_parts/section_clients.es6 */ "./src/js/template_parts/section_clients.es6");
  $(".form__wrapper").length > 0 && __webpack_require__(/*! ./template_parts/section_form.es6 */ "./src/js/template_parts/section_form.es6");
})(jQuery);
}();
/******/ })()
;
